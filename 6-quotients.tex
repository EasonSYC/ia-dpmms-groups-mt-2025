...
\begin{examples*}[Examples of Normal Subgroups]
    \begin{enumerate}
        ...
        \]
        by \autoref{lem:dihedral-relation} (Dihedral Relation). But \(\ang{s}\) is \emph{not} normal since
        \[
            r s r \inverse = s r^{-2} \notin \ang{s}.
        \]
